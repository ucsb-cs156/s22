...
<details>
<summary>
For details on the Recommendation request item click the triangle
</summary>


The `RecommendationRequest` table will use an autogenerated  `Long` as it's id field, and will have these additional fields:
...
<details>
<summary>
For details on the Dining Commons Review item click the triangle
</summary>


The `DiningCommonsReview` table will use an autogenerated  `Long` as it's id field, and will have these additional fields:
